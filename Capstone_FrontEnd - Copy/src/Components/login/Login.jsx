...
//             alert('Not registered');
//         } else {
//             const userData = await loginResponse.json(); // Assuming your API returns user data including role
//             alert('Login success');
...
//             alert('Login success');
//             localStorage.setItem('user', JSON.stringify(userData)); // Store user data including role
//             setRole(userData.role); // Store role in state
//         }
...
//         if (!role) {
//             setRole(storedRole); // Update role state if not already set
//         }
//     }
...
//             // Redirect to home page or handle navigation based on your app's logic
//             // Example: navigate to dashboard or another page
...
//     if (localStorage.getItem('user')) {
//         return <Navigate to="/" replace />; // Redirect if user is logged in
//     }
...
//             // Log the role to browser console
...
//         const userData = JSON.parse(localStorage.getItem('user'));
//         const role = userData.role;
//         console.log('user role giri:', role); // Print role in console
//         return <Navigate to="/" replace />; // Redirect if user is logged in
//     }
...
//         const userData = JSON.parse(localStorage.getItem('user'));
//         const role = userData.role;
//         console.log('User role:', role); // Print role in console
...
//                             {/* Left Column for Logo */}
//                             {/* <div className="col-md-4" style={{ paddingTop: '65px', background: 'transparent' }}>
//     <img src="https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/maroon-bus?qlt=82&wid=1024&ts=1660222495591&dpr=off&fit=constrain" alt="Logo" className="img-fluid" />
// </div> */}
